...
+ read data (only select columns for ECHO for speed)

The compliance history could be valuable for documenting recent lifespan -will compare to sdwis violations history. The fac major flag may indicate a subset to focus on for some analyses -e.g., presumably these have reasonably thorough data and may make a valuable comparison to water systems that are less thoroughly documented.

*Note: data.table fread nThread = 1 was fastest on my machine*
