...
*view multiples, appears can do string matching*
...
ga_NewEng_CT_1x_df2 <- ga_NewEng_CT_1x_df2 %>% 
  mutate(city_served2 = tolower(str_trim(city_served)))
# try making ascii-compatable eventually
...
Then hopefully NH shapefile to fill in that one at least
...
1. watsys_echoloc_I
2. watsys_noecholoc_NewEng_gaZC
3. watsys_noecholoc_NewEng_gaCT
