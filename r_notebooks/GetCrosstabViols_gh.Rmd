...
#### #*COMPLIANCE_STATUS_CODE seems to be most important for understanding violation timeline*
...
#### Filtering out COMPLIANCE_STATUS_CODE = "O" (open violation), PWS_ACTIVITY_CODE = "Active", cpbd (compliance period begin date) within period of interest, and tallying by IS_HEALTH_BASED_IND
...
#### Filtering out COMPLIANCE_STATUS_CODE = "K" (known: not really sure what this is yet), PWS_ACTIVITY_CODE = "Active", cpbd (compliance period begin date) within period of interest, and tallying by IS_HEALTH_BASED_IND
